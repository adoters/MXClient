...
public class TestProtoBuffer : LuaClient
{
    ...
    protected override void Bind()
    {
        ...
        _lua_state.BeginModule(null);
        TestProtolWrap.Register(_lua_state);
        _lua_state.EndModule();
    }
    ...
    {                
        base.OnLoadFinished();
        _lua_state.DoString(script, "TestProtoBuffer.cs");

#if !USE_PROTOBUF_NET
        LuaFunction func = _lua_state.GetFunction("Encoder");
        func.Call();
        func.Dispose();        

        func = _lua_state.GetFunction("Decoder");
        func.Call();
        func.Dispose();
        func = null;
#else
