...
public class TestCoroutine2 : LuaClient 
{
    ...
    protected override void OnLoadFinished()
    {
        ...
        _lua_state.DoString(script, "TestCoroutine2.cs");
        LuaFunction func = _lua_state.GetFunction("TestCo");
        func.Call();
        func.Dispose();
        func = null;
    }
    ...
    void OnGUI()
    {
        if (GUI.Button(new Rect(50, 50, 120, 45), "Start Counter"))
        {
            ...
            {
                beStart = true;
                LuaFunction func = _lua_state.GetFunction("StartDelay");
                func.Call();
                func.Dispose();
            }
        }
        else if (GUI.Button(new Rect(50, 150, 120, 45), "Stop Counter"))
        {
            ...
            {
                beStart = false;
                LuaFunction func = _lua_state.GetFunction("StopDelay");
                func.Call();
                func.Dispose();
            }
        }
